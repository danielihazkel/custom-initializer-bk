...
ALTER TABLE initializer_starter_template ADD COLUMN project_kind VARCHAR(20) NOT NULL DEFAULT 'BACKEND';

CREATE INDEX idx_starter_template_kind ON initializer_starter_template(project_kind);
