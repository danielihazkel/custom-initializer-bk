...
ALTER TABLE entity_template_set ADD COLUMN design_system VARCHAR(20);
ALTER TABLE entity_template_set ADD COLUMN boot_version_range VARCHAR(100);
ALTER TABLE entity_template_set ADD COLUMN java_version_range VARCHAR(100);
...
UPDATE entity_template_set SET design_system = 'TAILWIND' WHERE set_key = 'react-tailwind-crud';
